...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoSearchResultResponseDto>> searchTodo(
        ...
        return ResponseEntity.ok(todoService.searchByKey(titleKeyword,nicknameKeyword,startDate,endDate,page,size));
    }
